...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 627DF1680B5
	for <lists+linux-arm-kernel@lfdr.de>; Fri, 21 Feb 2020 15:48:53 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=g506WirCC2duhUMhY1B2ntr8wcqwqRAQec0JIM9CGu4=; b=VMvgkte/Q/HtA7hiSbMlzptFH
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1j59bf-0000Vm-G0; Fri, 21 Feb 2020 14:48:43 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
 id 1j59bV-0000V5-6j
 for linux-arm-kernel@lists.infradead.org; Fri, 21 Feb 2020 14:48:34 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id F11961FB;
 Fri, 21 Feb 2020 06:48:31 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 84B9B3F703;
 Fri, 21 Feb 2020 06:48:30 -0800 (PST)
...
X-Pep-Version: 2.0
Message-ID: <c438aa7e-2c96-8c11-bb87-204929a01a20@arm.com>
Date: Fri, 21 Feb 2020 14:48:29 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.4.1
MIME-Version: 1.0
In-Reply-To: <a81251e813d54caddd56b9aac4b55e85@kernel.org>
Content-Type: multipart/mixed; boundary="------------9A9294A373057682F8EDC095"
Content-Language: en-US
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200221_064833_339318_37C96AF4 
...
> Vincenzo,
>=20
> Please include Mark and myself for anything that touches the arch timer=
s
> (get_maintainer.pl will tell you who you need to cc).
>=20

Sorry about that, I posted it too quickly without the proper Cc on the pa=
tch.
...
arm_arch_timer the arch specific symbol is VDSO_CLOCKMODE_ARCHTIMER (used=
 for
...
Based on my investigation this fix should be replicated for all the clock=
sources
used by architectures supported by Unified VDSO and of which VDSOs can be=

disabled (otherwise the current solution works). After a quick grep on th=
e
kernel tree:
