...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id C4B16162D38
	for <lists+linux-arm-kernel@lfdr.de>; Tue, 18 Feb 2020 18:43:20 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=r75UWIln12G2cdzmcrhXKypv3vVuv5pNAXIhBGtxJ/8=; b=L5qB4ieKk0cE+K9A8kJAjGVzV
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1j46tr-0001fu-3y; Tue, 18 Feb 2020 17:43:11 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
 id 1j46tj-0001fE-97
 for linux-arm-kernel@lists.infradead.org; Tue, 18 Feb 2020 17:43:04 +0000
...
Content-Type: multipart/mixed; boundary="------------D5B825C5C4C06935DE8BE2EF"
Content-Language: en-US
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200218_094303_404346_59F6D5AD 
...
>=20
> Curious, but have you tested this change with the integrated assembler =
as
> well?
>=20

The integrated assembler as far as I am aware cannot assemble the kernel =
for
reasons independent from lse (AS=3Dclang generates a lot of errors). Not =
sure how
...
>>                                 -I ./include/uapi -I ./include/generat=
ed/uapi
>>                                 -I ./init -I ./init
>>                                 -march=3Darmv8.3-a -o init/do_mounts.o=

>>                                 /tmp/do_mounts-d7992a.s
>> /tmp/do_mounts-d7992a.s: Assembler messages:
>> /tmp/do_mounts-d7992a.s:1959: Error: selected processor does not suppo=
rt `autiasp'
>> /tmp/do_mounts-d7992a.s:2021: Error: selected processor does not suppo=
rt `paciasp'
>> /tmp/do_mounts-d7992a.s:2157: Error: selected processor does not suppo=
rt `autiasp'
>> /tmp/do_mounts-d7992a.s:2175: Error: selected processor does not suppo=
rt `paciasp'
>> /tmp/do_mounts-d7992a.s:2494: Error: selected processor does not suppo=
rt `autiasp'
>>
>> Fix the issue replacing ".arch armv8-a+lse" with ".arch_extension lse"=
 that does
>> not override the command line parameter.
>>
>> Fixes: e0d5896bd356cd ("arm64: lse: fix LSE atomics with LLVM's integr=
ated assembler")
...
>>
>> diff --git a/arch/arm64/include/asm/lse.h b/arch/arm64/include/asm/lse=
=2Eh
