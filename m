...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id E9C71165D75
	for <lists+linux-arm-kernel@lfdr.de>; Thu, 20 Feb 2020 13:23:18 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=qAPxb0pPXdkX/3gWuuTQaYh0CztB43aPfR17NJ5lF/A=; b=sdlUjWjI33PLiOuURzOgCuQzL
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1j4krB-0008Az-AV; Thu, 20 Feb 2020 12:23:05 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
 id 1j4kr2-0008AT-3f
 for linux-arm-kernel@lists.infradead.org; Thu, 20 Feb 2020 12:22:57 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 52B5030E;
 Thu, 20 Feb 2020 04:22:54 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 870EA3F6CF;
 Thu, 20 Feb 2020 04:22:53 -0800 (PST)
...
X-Pep-Version: 2.0
Message-ID: <df8fa53c-5c21-b620-0254-ffefdd3a8834@arm.com>
Date: Thu, 20 Feb 2020 12:22:52 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.4.1
MIME-Version: 1.0
In-Reply-To: <20200204175913.74901-6-avagin@gmail.com>
Content-Type: multipart/mixed; boundary="------------C9DAC135AE5C75D6221B72FB"
Content-Language: en-US
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200220_042256_243560_5848BA3A 
...
> namespace support.
>=20
> As the offset from timens to VVAR page is computed compile-time, the pa=
ges
> in VVAR should stay together and not being partically mremap()'ed.
>=20

I agree on the concept, but why do we need to redefine mremap?
special_mapping_mremap() (mm/mmap.c +3317) seems doing already the same t=
hing if
we leave mremap =3D=3D NULL as is.
...
> @@ -229,6 +229,17 @@ static vm_fault_t vvar_fault(const struct vm_speci=
al_mapping *sm,
...
> +{
> +	unsigned long new_size =3D new_vma->vm_end - new_vma->vm_start;
> +
> +	if (new_size !=3D VVAR_NR_PAGES * PAGE_SIZE)
> +		return -EINVAL;
> +
> +	return 0;
> +}
...
> @@ -311,6 +322,7 @@ static struct vm_special_mapping aarch32_vdso_spec[=
C_PAGES] =3D {
>  	{
>  		.name =3D "[vvar]",
>  		.fault =3D vvar_fault,
> +		.mremap =3D vvar_mremap,
>  	},
>  	{
>  		.name =3D "[vdso]",
> @@ -493,6 +505,7 @@ static struct vm_special_mapping vdso_spec[A_PAGES]=
 __ro_after_init =3D {
>  	{
>  		.name	=3D "[vvar]",
>  		.fault =3D vvar_fault,
