...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 416E857FFD
	for <lists+linux-arm-kernel@lfdr.de>; Thu, 27 Jun 2019 12:14:03 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=QEIkvArIZ3oNQ/eTFz8ca30IAw4LNMzFpBhsd5sQr+Q=; b=a4df9fhI3QAm0Q
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92 #3 (Red Hat Linux))
	id 1hgRPl-0006ou-EO; Thu, 27 Jun 2019 10:14:01 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92 #3 (Red Hat Linux))
 id 1hgRPT-0006o2-FX
 for linux-arm-kernel@lists.infradead.org; Thu, 27 Jun 2019 10:13:44 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 9386F2B;
 Thu, 27 Jun 2019 03:13:42 -0700 (PDT)
Received: from arrakis.emea.arm.com (arrakis.cambridge.arm.com [10.1.196.78])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id
 075D23F718; Thu, 27 Jun 2019 03:13:41 -0700 (PDT)
Date: Thu, 27 Jun 2019 11:13:39 +0100
From: Catalin Marinas <catalin.marinas@arm.com>
To: Will Deacon <will@kernel.org>
Subject: Re: [PATCH] arm64: Add support for E0PD
Message-ID: <20190627101339.GA9894@arrakis.emea.arm.com>
References: <20190626144535.27680-1-broonie@kernel.org>
 ...
 <20190627092529.a2hdttgitnile3h6@willie-the-truck>
MIME-Version: 1.0
Content-Disposition: inline
In-Reply-To: <20190627092529.a2hdttgitnile3h6@willie-the-truck>
User-Agent: Mutt/1.10.1 (2018-07-13)
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20190627_031343_605369_97618F3D 
...
On Thu, Jun 27, 2019 at 10:25:30AM +0100, Will Deacon wrote:
...
unmap_kernel_at_el0() currently forces kpti on if kaslr is enabled.
That's why I suggested placing al the checking logic in this function
and enabling E0PD via kpti_install_ng_mappings().

Anyway, it may be simpler if we do it as per Mark's patch here and
enable E0PD where available with a separate cpufeature entry while also
checking for the corresponding CPUID in unmap_kernel_at_el0() (and
return false if E0PD is present).
...
Ah, I misread the feature type. Then unmap_kernel_at_el0() returning
false if E0PD is present would not be a problem for normally booting
secondary CPUs, only for late ones.
