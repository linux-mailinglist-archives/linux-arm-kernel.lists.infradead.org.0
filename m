...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id DD3AA1B6295
	for <lists+linux-arm-kernel@lfdr.de>; Thu, 23 Apr 2020 19:48:13 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=jdoctft+jRVN8Kev03rN7cOw+AmE2q9WKOYBAw9r5fI=; b=B8Y3eIEqgC6a0K
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jRfxE-0002yj-5j; Thu, 23 Apr 2020 17:48:04 +0000
...
Subject: [PATCH v3 01/16] include/linux/ioport.h: add helper to define REG
 resource constructs
...
X-Spamd-Result: default: False [6.40 / 15.00]; FROM_HAS_DN(0.00)[];
 ...
 TO_MATCH_ENVRCPT_ALL(0.00)[]; NEURAL_SPAM(0.00)[1.014];
...
X-CRM114-CacheID: sfid-20200423_104634_862085_E38317AD 
