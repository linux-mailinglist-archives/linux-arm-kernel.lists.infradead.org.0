...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id A180A19A02
	for <lists+linux-arm-kernel@lfdr.de>; Fri, 10 May 2019 10:49:36 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=2mAKxZD5W00RxikEnoLA90hss/NvbxE09zhvnkSd2AQ=; b=pc/BvYw/+4+DBM
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.90_1 #2 (Red Hat Linux))
	id 1hP1Dh-0004gY-Cy; Fri, 10 May 2019 08:49:33 +0000
Received: from hqemgate15.nvidia.com ([216.228.121.64])
 by bombadil.infradead.org with esmtps (Exim 4.90_1 #2 (Red Hat Linux))
 id 1hP1Bv-0002hb-E5
 for linux-arm-kernel@lists.infradead.org; Fri, 10 May 2019 08:48:17 +0000
...
Received: from hqnvemgw02.nvidia.com (172.16.227.111) by HQMAIL107.nvidia.com
 ...
 Frontend Transport; Fri, 10 May 2019 08:47:41 +0000
...
Subject: [PATCH V3 6/8] memory: tegra: Add EMC scaling sequence code for
 Tegra210
...
X-CRM114-CacheID: sfid-20190510_014744_441036_087C8DE9 
...
+		u32 var;
+		u32 wval;
+		const u32 *burst_regs_off = &reg_off.burst_regs_off[0];
+
+		if (!burst_regs_off[i])
+			continue;
+
...
+		u64 trim_reg;
+		const u32 *trim_regs_off = &reg_off.trim_regs_off[0];
+
+		if (!trim_regs_off[i])
+			continue;
+
...
+
 enum {
 	REG_EMC,
 	REG_EMC0,
@@ -849,7 +1004,9 @@ void emc_writel_per_ch(struct tegra_emc *emc, u32 val, int type,
