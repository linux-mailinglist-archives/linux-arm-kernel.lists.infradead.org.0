...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 58C05CAB8B
	for <lists+linux-arm-kernel@lfdr.de>; Thu,  3 Oct 2019 19:40:19 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=upGzI3Rgm+ff1YLO5drVRgfCk/Z2CHYoISOQUVxm07g=; b=mBh4/X5ZSKAEMmmrvovvmtVC9
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.2 #3 (Red Hat Linux))
	id 1iG55M-0004Uq-JH; Thu, 03 Oct 2019 17:40:16 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.2 #3 (Red Hat Linux))
 id 1iG55B-0003zG-6B
 for linux-arm-kernel@lists.infradead.org; Thu, 03 Oct 2019 17:40:06 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 639FD1000;
 Thu,  3 Oct 2019 10:40:04 -0700 (PDT)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 431653F739;
 Thu,  3 Oct 2019 10:40:03 -0700 (PDT)
...
References: <20191002144156.2174-1-vincenzo.frascino@arm.com>
 ...
 <20191003161621.GJ21629@arrakis.emea.arm.com>
From: Vincenzo Frascino <vincenzo.frascino@arm.com>
Message-ID: <80c92957-d260-0420-9422-8743a698bdaa@arm.com>
Date: Thu, 3 Oct 2019 18:40:02 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.8.0
MIME-Version: 1.0
In-Reply-To: <20191003161621.GJ21629@arrakis.emea.arm.com>
Content-Type: multipart/mixed; boundary="------------BC81F0FC7B9608F644BDDDD5"
Content-Language: en-US
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20191003_104005_339498_B768BA69 
...
>>> @@ -53,20 +53,12 @@ $(warning Detected assembler with broken .inst; d=
isassembly will be unreliable)
>>>    endif
>>>  endif
>>> =20
...
>>> -    $(warning CROSS_COMPILE_COMPAT is clang, the compat vDSO will no=
t be built)
>>> -  else ifeq ($(strip $(CROSS_COMPILE_COMPAT)),)
>>> -    $(warning CROSS_COMPILE_COMPAT not defined or empty, the compat =
vDSO will not be built)
>>> -  else ifeq ($(shell which $(CROSS_COMPILE_COMPAT)gcc 2> /dev/null),=
)
>>> -    $(error $(CROSS_COMPILE_COMPAT)gcc not found, check CROSS_COMPIL=
E_COMPAT)
>>> -  else
...
>> which cannot build the vdso32. What I really want is not to warn me, n=
or
...
>> of the GENERIC_COMPAT_VDSO dependent on this check. This was now dropp=
ed
>> from the previous version of the patch. We could add something like
>> COMPATCC_CAN_LINK.
>=20
> Ah, the COMPATCC_CAN_LINK idea doesn't help because an x86 gcc can stil=
l
> link. Maybe only enable CONFIG_COMPAT_VDSO above if CROSS_COMPILE_COMPA=
T
> was set. You could move the COMPATCC setting and export under the
> same 'if' block in the Makefile.
>=20

The snippet below the scissors solves the problem for me. I am going to r=
e-post
...
+	select GENERIC_COMPAT_VDSO if (!CPU_BIG_ENDIAN && COMPAT && !COMPATCC_E=
MPTY)
