...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F4F1109CC9
	for <lists+linux-arm-kernel@lfdr.de>; Tue, 26 Nov 2019 12:10:39 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=zgWPwnlL/0nsXvfxHvSXjmsXX7pvJzSTG4X/SQnKMgc=; b=jObNQN8m8tw5VwwkritJM2LKA
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iZYji-0002aE-7S; Tue, 26 Nov 2019 11:10:26 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
 id 1iZYjI-00020W-Ob
 for linux-arm-kernel@lists.infradead.org; Tue, 26 Nov 2019 11:10:02 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 262161FB;
 Tue, 26 Nov 2019 03:09:58 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 733AF3F52E;
 Tue, 26 Nov 2019 03:09:57 -0800 (PST)
Subject: Re: why no stack protector for vdso
To: linfeilong <linfeilong@huawei.com>, Marc Gonzalez <marc.w.gonzalez@free.fr>
References: <82a77dfebc9649bd90b0ad6b8a47ffdd@huawei.com>
From: Vincenzo Frascino <vincenzo.frascino@arm.com>
Message-ID: <5239704a-c4f3-3338-d242-dca357de8c91@arm.com>
Date: Tue, 26 Nov 2019 11:09:56 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.9.0
MIME-Version: 1.0
In-Reply-To: <82a77dfebc9649bd90b0ad6b8a47ffdd@huawei.com>
Content-Type: multipart/mixed; boundary="------------02DD476A9AC57B883BB4DDD0"
Content-Language: en-US
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20191126_031000_909643_2179520A 
...
>=20
> Sorry, I can't well understand. As I know, with -fstack-protect a canar=
y is pushed ,=20
> and then  checked before return.   __stack_chk_fail will be called if f=
ailed.
> Maybe the reason is that vdso can not link to __stack_chk_fail of glibc=
 as it is=20
> compiled fully in kernel , so we should keep -fno-stack-protector?
>

The vdso library is self-contained and does not link against any other li=
brary.
-fstack-protector as you correctly pointed out would require external sym=
bols.
