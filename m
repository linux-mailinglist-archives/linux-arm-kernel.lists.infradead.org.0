...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 32E34114E9
	for <lists+linux-arm-kernel@lfdr.de>; Thu,  2 May 2019 10:09:07 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=8HNGYTRdh7FicdTwLdJdZw6HN0bneVK/Sh+nM5tSUpk=; b=NUZVZhqlJQvPkK
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.90_1 #2 (Red Hat Linux))
	id 1hM6m8-00085S-FE; Thu, 02 May 2019 08:09:04 +0000
Received: from mail-eopbgr30046.outbound.protection.outlook.com ([40.107.3.46]
 helo=EUR03-AM5-obe.outbound.protection.outlook.com)
 by bombadil.infradead.org with esmtps (Exim 4.90_1 #2 (Red Hat Linux))
 id 1hM6kD-0005Pk-Bn
 for linux-arm-kernel@lists.infradead.org; Thu, 02 May 2019 08:07:37 +0000
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 02 May 2019 08:06:53.4725 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: 686ea1d3-bc2b-4c6f-a92c-d99c5c301635
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-Transport-CrossTenantHeadersStamped: AM0PR04MB6161
X-Spam-Note: CRM114 run bypassed due to message size (104455 bytes)
X-Spam-Score: -0.2 (/)
...
index 4ed180c..bd8ee9a 100644
--- a/drivers/clk/imx/clk-imx6sx.c
+++ b/drivers/clk/imx/clk-imx6sx.c
@@ -89,8 +89,8 @@ static const char *pll5_bypass_sels[] = { "pll5", "pll5_bypass_src", };
...
+static struct clk_hw_onecell_data *clk_hw_data;
 ...
 static const struct clk_div_table clk_enet_ref_table[] = {
 	{ .val = 0, .div = 20, },
@@ -124,76 +124,86 @@ static u32 share_count_ssi3;
...
@@ -201,359 +211,363 @@ static void __init imx6sx_clocks_init(struct device_node *ccm_node)
...
+	hws[IMX6SX_CLK_MMDC_P1_IPG]  = imx_clk_hw_gate2("mmdc_p1_ipg", "ipg", base + 0x74, 26);
