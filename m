...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id C7CD2999B7
	for <lists+linux-arm-kernel@lfdr.de>; Thu, 22 Aug 2019 19:04:34 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=dQZITCUeAMX2yQbiFJ0XI4tF/K1dDDou3upc0DFuPwc=; b=R9QktbNiec9fEF
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92 #3 (Red Hat Linux))
	id 1i0qVi-0003xk-Pe; Thu, 22 Aug 2019 17:04:30 +0000
Received: from honk.sigxcpu.org ([24.134.29.49])
 by bombadil.infradead.org with esmtps (Exim 4.92 #3 (Red Hat Linux))
 id 1i0qVU-0003wq-0B
 for linux-arm-kernel@lists.infradead.org; Thu, 22 Aug 2019 17:04:21 +0000
...
X-CRM114-CacheID: sfid-20190822_100416_685500_8795163C 
...
> limit the maximum DSI=A0throughput to 1.5Gbps, while the maximum is 6Gbps
> (1.5 * 4 lanes)
...
> and move nwl_dsi_config_host=A0in there. Thus, the call flow will be:
