...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id EDE4BFB4B0
	for <lists+linux-arm-kernel@lfdr.de>; Wed, 13 Nov 2019 17:12:37 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	References:List-Owner; bh=/3BVuP2IZc/NK0BgaGSBIb6qDskqOk8aLhHFuqPthj8=; b=Cl/
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iUvFz-0005yf-Sn; Wed, 13 Nov 2019 16:12:35 +0000
...
Received: from orsmga005.jf.intel.com ([10.7.209.41])
 ...
 13 Nov 2019 08:12:14 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.68,300,1569308400"; 
 d="gz'50?scan'50,208,50";a="379271693"
Received: from lkp-server01.sh.intel.com (HELO lkp-server01) ([10.239.97.150])
 by orsmga005.jf.intel.com with ESMTP; 13 Nov 2019 08:12:11 -0800
Received: from kbuild by lkp-server01 with local (Exim 4.89)
 (envelope-from <lkp@intel.com>)
 id 1iUvFb-0008hT-CC; Thu, 14 Nov 2019 00:12:11 +0800
Date: Thu, 14 Nov 2019 00:11:23 +0800
From: kbuild test robot <lkp@intel.com>
To: Marc Zyngier <maz@kernel.org>
Subject: [arm-platforms:kvm-arm64/vcpu-xarray 49/49]
 arch/s390/kvm/kvm-s390.c:4151:33: error: 'struct kvm' has no member named
 'vcpus'
Message-ID: <201911140004.oQA5pSzJ%lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="wbdvfh3kyiempldn"
Content-Disposition: inline
X-Patchwork-Hint: ignore
User-Agent: NeoMutt/20170113 (1.7.2)
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20191113_081215_042548_94F87F61 
...
All errors (new ones prefixed by >>):
   ...
   arch/s390/kvm/kvm-s390.c:3021:32: error: 'id' undeclared (first use in this function); did you mean 'fd'?
     vcpu->arch.sie_block->icpua = id;
                                   ^~
                                   fd
   arch/s390/kvm/kvm-s390.c:3021:32: note: each undeclared identifier is reported only once for each function it appears in
   arch/s390/kvm/kvm-s390.c:3023:39: error: 'kvm' undeclared (first use in this function)
     vcpu->arch.sie_block->gd = (u32)(u64)kvm->arch.gisa_int.origin;
                                          ^~~
   arch/s390/kvm/kvm-s390.c: In function 'kvm_s390_vcpu_start':
>> arch/s390/kvm/kvm-s390.c:4151:33: error: 'struct kvm' has no member named 'vcpus'
      if (!is_vcpu_stopped(vcpu->kvm->vcpus[i]))
                                    ^~
   arch/s390/kvm/kvm-s390.c: In function 'kvm_s390_vcpu_stop':
   arch/s390/kvm/kvm-s390.c:4197:33: error: 'struct kvm' has no member named 'vcpus'
      if (!is_vcpu_stopped(vcpu->kvm->vcpus[i])) {
                                    ^~
   arch/s390/kvm/kvm-s390.c:4199:28: error: 'struct kvm' has no member named 'vcpus'
       started_vcpu = vcpu->kvm->vcpus[i];
                               ^~

vim +4151 arch/s390/kvm/kvm-s390.c

b0c632db637d68 Heiko Carstens    2008-03-25  4137  
6852d7b69b4949 David Hildenbrand 2014-03-14  4138  void kvm_s390_vcpu_start(struct kvm_vcpu *vcpu)
6852d7b69b4949 David Hildenbrand 2014-03-14  4139  {
8ad357551797b1 David Hildenbrand 2014-03-14  4140  	int i, online_vcpus, started_vcpus = 0;
b0c632db637d68 Heiko Carstens    2008-03-25  4141  
8ad357551797b1 David Hildenbrand 2014-03-14  4142  	if (!is_vcpu_stopped(vcpu))
8ad357551797b1 David Hildenbrand 2014-03-14  4143  		return;
b0c632db637d68 Heiko Carstens    2008-03-25  4144  
6852d7b69b4949 David Hildenbrand 2014-03-14  4145  	trace_kvm_s390_vcpu_start_stop(vcpu->vcpu_id, 1);
8ad357551797b1 David Hildenbrand 2014-03-14  4146  	/* Only one cpu at a time may enter/leave the STOPPED state. */
433b9ee43c2337 David Hildenbrand 2014-05-06  4147  	spin_lock(&vcpu->kvm->arch.start_stop_lock);
8ad357551797b1 David Hildenbrand 2014-03-14  4148  	online_vcpus = atomic_read(&vcpu->kvm->online_vcpus);
8ad357551797b1 David Hildenbrand 2014-03-14  4149  
8ad357551797b1 David Hildenbrand 2014-03-14  4150  	for (i = 0; i < online_vcpus; i++) {
8ad357551797b1 David Hildenbrand 2014-03-14 @4151  		if (!is_vcpu_stopped(vcpu->kvm->vcpus[i]))
8ad357551797b1 David Hildenbrand 2014-03-14  4152  			started_vcpus++;
b0c632db637d68 Heiko Carstens    2008-03-25  4153  	}
b0c632db637d68 Heiko Carstens    2008-03-25  4154  
8ad357551797b1 David Hildenbrand 2014-03-14  4155  	if (started_vcpus == 0) {
8ad357551797b1 David Hildenbrand 2014-03-14  4156  		/* we're the only active VCPU -> speed it up */
8ad357551797b1 David Hildenbrand 2014-03-14  4157  		__enable_ibs_on_vcpu(vcpu);
8ad357551797b1 David Hildenbrand 2014-03-14  4158  	} else if (started_vcpus == 1) {
8ad357551797b1 David Hildenbrand 2014-03-14  4159  		/*
8ad357551797b1 David Hildenbrand 2014-03-14  4160  		 * As we are starting a second VCPU, we have to disable
8ad357551797b1 David Hildenbrand 2014-03-14  4161  		 * the IBS facility on all VCPUs to remove potentially
8ad357551797b1 David Hildenbrand 2014-03-14  4162  		 * oustanding ENABLE requests.
8ad357551797b1 David Hildenbrand 2014-03-14  4163  		 */
8ad357551797b1 David Hildenbrand 2014-03-14  4164  		__disable_ibs_on_all_vcpus(vcpu->kvm);
8ad357551797b1 David Hildenbrand 2014-03-14  4165  	}
8ad357551797b1 David Hildenbrand 2014-03-14  4166  
9daecfc6601553 David Hildenbrand 2018-01-23  4167  	kvm_s390_clear_cpuflags(vcpu, CPUSTAT_STOPPED);
8ad357551797b1 David Hildenbrand 2014-03-14  4168  	/*
8ad357551797b1 David Hildenbrand 2014-03-14  4169  	 * Another VCPU might have used IBS while we were offline.
8ad357551797b1 David Hildenbrand 2014-03-14  4170  	 * Let's play safe and flush the VCPU at startup.
8ad357551797b1 David Hildenbrand 2014-03-14  4171  	 */
d3d692c82e4ed7 David Hildenbrand 2014-07-29  4172  	kvm_make_request(KVM_REQ_TLB_FLUSH, vcpu);
433b9ee43c2337 David Hildenbrand 2014-05-06  4173  	spin_unlock(&vcpu->kvm->arch.start_stop_lock);
8ad357551797b1 David Hildenbrand 2014-03-14  4174  	return;
6852d7b69b4949 David Hildenbrand 2014-03-14  4175  }
6852d7b69b4949 David Hildenbrand 2014-03-14  4176  

:::::: The code at line 4151 was first introduced by commit
:::::: 8ad357551797b1edc184fb9f6a4f80a6fa626459 KVM: s390: enable IBS for single running VCPUs
...
H4sICNUqzF0AAy5jb25maWcAjDzbctw2su/5iinnZbe2kkiWLMfnlB5AEpxBhiRoApzR6IWl
