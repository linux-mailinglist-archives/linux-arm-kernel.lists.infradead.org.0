...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 13F79146562
	for <lists+linux-arm-kernel@lfdr.de>; Thu, 23 Jan 2020 11:11:01 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=ZEYYUjLF9traWZlI1qbNuTznLIQfP0jMkFvxVYSBvSc=; b=ejATb9VBEnTshk5WePCbPW+E4
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iuZRt-0001QU-Qq; Thu, 23 Jan 2020 10:10:53 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
 id 1iuZRl-0001Pu-3f
 for linux-arm-kernel@lists.infradead.org; Thu, 23 Jan 2020 10:10:46 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 836F931B;
 Thu, 23 Jan 2020 02:10:41 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 302E33F6C4;
 Thu, 23 Jan 2020 02:10:40 -0800 (PST)
...
References: <bc4cc5c0-5192-4772-5444-17bba3ab74fa@free.fr>
 ...
 <89ebe43d-e2df-fcfb-f31f-bd6dca528c02@free.fr>
From: Vincenzo Frascino <vincenzo.frascino@arm.com>
X-Pep-Version: 2.0
Message-ID: <f662f187-45d0-6e29-10ca-d25f3ce6a09c@arm.com>
Date: Thu, 23 Jan 2020 10:10:38 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.4.1
MIME-Version: 1.0
In-Reply-To: <89ebe43d-e2df-fcfb-f31f-bd6dca528c02@free.fr>
Content-Type: multipart/mixed; boundary="------------294B27A5D25F8D824394B0D2"
Content-Language: en-US
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200123_021045_245447_E1863748 
...
>=20
> I haven't upgraded sparse yet, but I've been playing with make W=3D1 la=
tely,
> using gcc 9.2. On v5.5-rc1, I see the following warnings:
>=20
>   CC      arch/arm64/kernel/vdso/vgettimeofday.o
> In file included from <command-line>:
> /home/mgonzalez/linux/lib/vdso/gettimeofday.c:224:5: warning: no previo=
us prototype for '__cvdso_clock_getres' [-Wmissing-prototypes]
>   224 | int __cvdso_clock_getres(clockid_t clock, struct __kernel_times=
pec *res)
>       |     ^~~~~~~~~~~~~~~~~~~~
> arch/arm64/kernel/vdso/vgettimeofday.c:11:5: warning: no previous proto=
type for '__kernel_clock_gettime' [-Wmissing-prototypes]
>    11 | int __kernel_clock_gettime(clockid_t clock,
>       |     ^~~~~~~~~~~~~~~~~~~~~~
> arch/arm64/kernel/vdso/vgettimeofday.c:17:5: warning: no previous proto=
type for '__kernel_gettimeofday' [-Wmissing-prototypes]
>    17 | int __kernel_gettimeofday(struct __kernel_old_timeval *tv,
>       |     ^~~~~~~~~~~~~~~~~~~~~
> arch/arm64/kernel/vdso/vgettimeofday.c:23:5: warning: no previous proto=
type for '__kernel_clock_getres' [-Wmissing-prototypes]
...
ffd08731b2d632459428612431060cf902324a8d
