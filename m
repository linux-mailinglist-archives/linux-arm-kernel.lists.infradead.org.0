...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 266CEDB07E
	for <lists+linux-arm-kernel@lfdr.de>; Thu, 17 Oct 2019 16:53:05 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	References:List-Owner; bh=WiFjKeKDVqiYBunrDKjxelTrDdDOKa8xRM7gzt60sBQ=; b=At8
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iL79D-0002JU-Jd; Thu, 17 Oct 2019 14:53:03 +0000
Received: from mga05.intel.com ([192.55.52.43])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1iL78u-0002GK-JW
 for linux-arm-kernel@lists.infradead.org; Thu, 17 Oct 2019 14:52:48 +0000
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
 by fmsmga105.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 17 Oct 2019 07:52:43 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.67,308,1566889200"; 
 d="gz'50?scan'50,208,50";a="195928688"
Received: from lkp-server01.sh.intel.com (HELO lkp-server01) ([10.239.97.150])
 by fmsmga007.fm.intel.com with ESMTP; 17 Oct 2019 07:52:41 -0700
Received: from kbuild by lkp-server01 with local (Exim 4.89)
 (envelope-from <lkp@intel.com>)
 id 1iL78q-000Dun-Mk; Thu, 17 Oct 2019 22:52:40 +0800
Date: Thu, 17 Oct 2019 22:52:31 +0800
From: kbuild test robot <lkp@intel.com>
To: Sam Tebbs <sam.tebbs@arm.com>
Subject: [arm64:for-next/cortex-strings 5/8] arch/arm64/lib/strcmp.S:118:
 Error: immediate value out of range 0 to 63 at operand 3 -- `lsr x2,x2,#560'
Message-ID: <201910172230.ivl8ggwi%lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="v7ii7cnc7aqoqs6a"
Content-Disposition: inline
X-Patchwork-Hint: ignore
User-Agent: NeoMutt/20170113 (1.7.2)
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20191017_075244_753382_97BED50F 
...
commit: 51b82a32879028ca9339f945f77eb3a166263eee [5/8] arm64: Import latest version of Cortex Strings' strcmp
config: arm64-allyesconfig (attached as .config)
compiler: aarch64-linux-gcc (GCC) 7.4.0
reproduce:
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        git checkout 51b82a32879028ca9339f945f77eb3a166263eee
...
vim +118 arch/arm64/lib/strcmp.S

    50	
    51		/* Start of performance-critical section  -- one 64B cache line.  */
    52	WEAK(strcmp)
    ...
    69		bic	has_nul, tmp1, tmp2	/* Non-zero if NUL terminator.  */
    70		orr	syndrome, diff, has_nul
    71		cbz	syndrome, L(loop_aligned)
    72		/* End of performance-critical section  -- one 64B cache line.  */
    73	
    74	L(end):
    75	CPU_LE(rev	syndrome, syndrome)
    76	CPU_LE(rev	data1, data1)
    77		/* The MS-non-zero bit of the syndrome marks either the first bit
    78		   that is different, or the top bit of the first zero byte.
    79		   Shifting left now will bring the critical information into the
    80		   top bits.  */
    81	CPU_LE(clz	pos, syndrome)
    82	CPU_LE(rev	data2, data2)
    83	CPU_LE(lsl	data1, data1, pos)
    84	CPU_LE(lsl	data2, data2, pos)
    85		/* But we need to zero-extend (char is unsigned) the value and then
    86		   perform a signed 32-bit subtraction.  */
    87	CPU_LE(lsr	data1, data1, #56)
    88	CPU_LE(sub	result, data1, data2, lsr #56)
    89	CPU_LE(ret)
    ...
    96	CPU_BE(cbnz	has_nul, 1f)
    97	CPU_BE(cmp	data1, data2)
    98	CPU_BE(cset	result, ne)
    99	CPU_BE(cneg	result, result, lo)
   100	CPU_BE(ret)
   101	1:
   102		/* Re-compute the NUL-byte detection, using a byte-reversed value.  */
   103	CPU_BE(rev	tmp3, data1)
   104	CPU_BE(sub	tmp1, tmp3, zeroones)
   105	CPU_BE(orr	tmp2, tmp3, #REP8_7f)
   106	CPU_BE(bic	has_nul, tmp1, tmp2)
   107	CPU_BE(rev	has_nul, has_nul)
   108	CPU_BE(orr	syndrome, diff, has_nul)
   109	CPU_BE(clz	pos, syndrome)
   ...
   113		   top bits.  */
   114	CPU_BE(lsl	data1, data1, pos)
   115	CPU_BE(lsl	data2, data2, pos)
   116		/* But we need to zero-extend (char is unsigned) the value and then
   117		   perform a signed 32-bit subtraction.  */
 > 118	CPU_BE(lsr	data1, data1, #560)
   119	CPU_BE(sub	result, data1, data2, lsr #56)
   120	CPU_BE(ret)
   121	
...
H4sICDN3qF0AAy5jb25maWcAnDzZciM3ku/+Ckb7ZSYm7OElSt4NPYAoFAmzLhVQPPRSQavZ
