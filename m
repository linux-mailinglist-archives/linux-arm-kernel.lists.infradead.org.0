...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 1A8A8631A6
	for <lists+linux-arm-kernel@lfdr.de>; Tue,  9 Jul 2019 09:12:01 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=GEmNOnlQrDGZO9PZlCoclzct5tzfJhoNI1WzMy9AlFg=; b=UbYGNQ2zvL5oow
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92 #3 (Red Hat Linux))
	id 1hkkIA-0004zj-V3; Tue, 09 Jul 2019 07:11:59 +0000
Received: from metis.ext.pengutronix.de ([2001:67c:670:201:290:27ff:fe1d:cc33])
 by bombadil.infradead.org with esmtps (Exim 4.92 #3 (Red Hat Linux))
 id 1hkkHt-0004yN-Fd
 for linux-arm-kernel@lists.infradead.org; Tue, 09 Jul 2019 07:11:46 +0000
...
X-Uptime: 08:56:52 up 52 days, 13:15, 50 users,  load average: 0.00, 0.05, 0.03
...
X-CRM114-CacheID: sfid-20190709_001142_062844_7D66CA23 
X-CRM114-Status: GOOD (  44.89  )
X-Spam-Score: 0.0 (/)
...
rch/arm/boot/dts/imx6q-apalis-ixora-v1.1.dts
> =

> https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/a=
rch/arm/boot/dts/tegra124-apalis-v1.2-eval.dts
> =
...
> > > > / {
> > > >         model =3D "Toradex Colibri iMX6DL/S V1.1 on Colibri
> > > > Evaluation Board V3";
> > > > };
> > > > =
...
> > > > /* Colibri MMC */
> > > > &usdhc1 {
> > > >         pinctrl-names =3D "default", "state_100mhz",
> > > > "state_200mhz";
...
> > > > > +     model =3D "Toradex Colibri iMX6DL/S V1.1 on Colibri
> > > > > Evaluation Board V3";
> > > > > +     compatible =3D "toradex,colibri_imx6dl-eval-v3",
...
> > > > > +     sram@0,0 {
> > > > > +             compatible =3D "cypress,cy7c1019dv33-10zsxi, mtd-
> > > > > ram";
> > > > > +             reg =3D <0 0 0x00010000>;
> > > > > +             #address-cells =3D <1>;
> > > > > +             #size-cells =3D <1>;
> > > > > +             bank-width =3D <2>;
> > > > > +             fsl,weim-cs-timing =3D <0x00010081 0x00000000
> > > > > 0x04000000
...
> > > > > +             enable-gpios =3D <&gpio3 26 GPIO_ACTIVE_HIGH>; /*
> > > > > Colibri BL_ON */
> > > > > +             status =3D "disabled";
> > > > > +     };
> > > > > +
...
> > > > > +     scl-gpios =3D <&gpio1 3 (GPIO_ACTIVE_HIGH |
> > > > > GPIO_OPEN_DRAIN)>;
> > > > > +     sda-gpios =3D <&gpio1 6 (GPIO_ACTIVE_HIGH |
> > > > > GPIO_OPEN_DRAIN)>;
> > > > > +     status =3D "disabled";
> > > > > +};
> > > > > +
