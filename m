...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 794061A3A96
	for <lists+linux-arm-kernel@lfdr.de>; Thu,  9 Apr 2020 21:34:45 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=YUrdnlbdl3hiD15uFhxa6q/kEpis840Z0NhE6JXOhhk=; b=Xomh6zZ5Wc2vUR
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jMcwa-0000k9-Bd; Thu, 09 Apr 2020 19:34:32 +0000
Received: from mail-dm6nam10on20612.outbound.protection.outlook.com
 ([2a01:111:f400:7e88::612]
 helo=NAM10-DM6-obe.outbound.protection.outlook.com)
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jMcwP-0000j5-3d
 for linux-arm-kernel@lists.infradead.org; Thu, 09 Apr 2020 19:34:25 +0000
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 09 Apr 2020 19:34:14.3823 (UTC)
...
X-CRM114-CacheID: sfid-20200409_123421_350959_1A906FC0 
...
> 
[Vishal Sagar] 
Ok. I will remove the depends line in next version. 
...
There is no limit on width and height from the protocol perspective. 
...
> > +				v4lendpoint.base.id);
> > +
> > +			dev_dbg(core->dev, "%s : mipi number lanes =
> %d\n",
> > +				__func__,
...
I will change the SPDX header to GPL-v2.0 as it is similar to other files in this folder.
