...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id D9541CEAF2
	for <lists+linux-arm-kernel@lfdr.de>; Mon,  7 Oct 2019 19:48:28 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=9MMpaZlB9px2EU2kvWtAb8EeIEWC2LA7anHgFTJUCJA=; b=bWhpSeMzhqVLLhSI/B/GLBMi7
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.2 #3 (Red Hat Linux))
	id 1iHX7G-0003kz-Ul; Mon, 07 Oct 2019 17:48:14 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.2 #3 (Red Hat Linux))
 id 1iHX77-0003k6-KH
 for linux-arm-kernel@lists.infradead.org; Mon, 07 Oct 2019 17:48:07 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 2E4211570;
 Mon,  7 Oct 2019 10:48:03 -0700 (PDT)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 0EFA93F68E;
 Mon,  7 Oct 2019 10:48:01 -0700 (PDT)
...
Message-ID: <2b3b3255-6532-e70c-8d1a-8d60308adbe1@arm.com>
Date: Mon, 7 Oct 2019 18:48:00 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.8.0
MIME-Version: 1.0
In-Reply-To: <ba8f3b9a-714f-08da-f93e-d832283697e2@arm.com>
Content-Type: multipart/mixed; boundary="------------758EF12F58BEE6071E1DDB01"
Content-Language: en-US
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20191007_104805_757002_7CC4A451 
...
>>>>> This patch series is meant to address the various compilation issue=
s
>>>>> reported recently for arm64 vdso32 [1].
>>>>>
>>>>> From v4, the series contains a cleanup of lib/vdso Kconfig as well =
since
>>>>> CROSS_COMPILE_COMPAT_VDSO is not required anymore by any architectu=
re.
>>>>
>>>> I've queued this up as fixes for 5.4, but I ended up making quite a =
few
>>>> additional changes to address some other issues and minor inconsiste=
ncies
>>>> I ran into. In particular, with my changes, you can now easily build=
 the
>>>> kernel with clang but the compat vDSO with gcc. The header files sti=
ll need
>>>> sorting out properly, but I think this is a decent starting point:
>>>>
>>>> https://git.kernel.org/pub/scm/linux/kernel/git/arm64/linux.git/log/=
?h=3Dfor-next/fixes
>>>>
>>>> Please have a look.
>>>>
...
>> Thanks.
>>
>>> I see acked-by Catalin on the patches, did you post them in review so=
mewhere? I
>>> could not find them. Sorry
>>
>> I pushed them out to a temporary vdso branch on Friday and Catalin loo=
ked at
>> that. If you'd like me to post them as well, please let me know, altho=
ugh
>> I'm keen to get this stuff sorted out by -rc3 without disabling the co=
mpat
>> vDSO altogether (i.e. [1]). In other words, if you're ok with my chang=
es on
>> top of yours then let's go for that, otherwise let's punt this to 5.5 =
and
>> try to fix the header mess at the same time.
>>
>=20
> No need to repost them. I just got confused by the fact that they got a=
cked and
> I could not find them anywhere, hence my question.
>=20
> I am keen to sort this thing as well, my personal preference is to not =
disable
> compat vdso in 5.4.
>=20
> I will download your tree, have a look at it and let you know my though=
ts.
>=20

I tested your patches and they look fine to me. I have just one request, =
in the
commit message of patch were you rename COMPATCC to CC_COMPAT could you p=
lease
add the make command with the update variable?

   $ make ARCH=3Darm64 CROSS_COMPILE=3Daarch64-linux-gnu- \
        CROSS_COMPILE_COMPAT=3Darm-linux-gnueabihf- CC=3Dclang \
        CC_COMPAT=3Darm-linux-gnueabihf-gcc
...
>> Will
>>
>> [1] https://lkml.kernel.org/r/20190925130926.50674-1-catalin.marinas@a=
rm.com
>>
>=20
