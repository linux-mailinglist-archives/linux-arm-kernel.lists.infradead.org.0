...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 50FF5195926
	for <lists+linux-arm-kernel@lfdr.de>; Fri, 27 Mar 2020 15:37:59 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=BSFfkQ9SD0HlUd/8j49ax/AjiDOB4fjugmOYDXhIN7Q=; b=qYfOAL6tF2cxH8TQu5AqsWe8e1
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jHq7G-0007Zo-Gt; Fri, 27 Mar 2020 14:37:46 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jHq4V-0004IW-QL
 for linux-arm-kernel@lists.infradead.org; Fri, 27 Mar 2020 14:34:59 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 8604511D4;
 Fri, 27 Mar 2020 07:34:54 -0700 (PDT)
Received: from e120937-lin.home (unknown [172.31.20.19])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 5C1AF3F71F;
 Fri, 27 Mar 2020 07:34:53 -0700 (PDT)
From: Cristian Marussi <cristian.marussi@arm.com>
To: linux-kernel@vger.kernel.org,
	linux-arm-kernel@lists.infradead.org
Subject: [PATCH v6 06/13] firmware: arm_scmi: Add notification
 callbacks-registration
Date: Fri, 27 Mar 2020 14:34:31 +0000
Message-Id: <20200327143438.5382-7-cristian.marussi@arm.com>
...
X-CRM114-CacheID: sfid-20200327_073455_983043_A0BA14D2 
...
index 0679f10ab05e..934b91d29311 100644
...
@@ -211,6 +213,49 @@ struct scmi_reset_ops {
...
+
  ...
  *
@@ -221,6 +266,7 @@ struct scmi_reset_ops {
...
@@ -242,6 +288,7 @@ struct scmi_handle {
