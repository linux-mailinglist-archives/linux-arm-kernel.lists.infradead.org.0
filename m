...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id D5072186E3D
	for <lists+linux-arm-kernel@lfdr.de>; Mon, 16 Mar 2020 16:06:53 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=rM9S/XzaRgxVDWbi38L41uLyfJ2UXQtSJ6t509P4qVw=; b=b5WrObfzfYMgikmFYq5Swa9IX2
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1jDrK9-00009W-Vh; Mon, 16 Mar 2020 15:06:38 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
 id 1jDrHu-00056o-VN
 for linux-arm-kernel@lists.infradead.org; Mon, 16 Mar 2020 15:04:22 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id ED746139F;
 Mon, 16 Mar 2020 08:04:17 -0700 (PDT)
Received: from e120937-lin.cambridge.arm.com (e120937-lin.cambridge.arm.com
 [10.1.197.50])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id EDE833F7C3;
 Mon, 16 Mar 2020 08:04:16 -0700 (PDT)
From: Cristian Marussi <cristian.marussi@arm.com>
To: linux-kernel@vger.kernel.org,
	linux-arm-kernel@lists.infradead.org
Subject: [PATCH v5 07/13] firmware: arm_scmi: Add notification dispatch and
 delivery
Date: Mon, 16 Mar 2020 15:03:28 +0000
Message-Id: <20200316150334.47463-8-cristian.marussi@arm.com>
...
X-CRM114-CacheID: sfid-20200316_080419_316686_949330E4 
...
@@ -161,6 +185,7 @@ struct scmi_registered_protocol_events_desc;
...
@@ -179,6 +204,8 @@ struct scmi_notify_instance {
...
@@ -188,12 +215,16 @@ struct scmi_notify_instance {
...
+	struct workqueue_struct		*wq;
 ...
 /**
@@ -315,9 +346,246 @@ struct scmi_event_handler {
...
@@ -340,13 +608,22 @@ static void scmi_kfifo_free(void *kfifo)
...
+	return ret;
 ...
 /**
@@ -746,6 +1023,37 @@ scmi_get_or_create_handler(struct scmi_notify_instance *ni, u32 evt_key)
...
@@ -861,6 +1169,16 @@ static void scmi_put_handler(struct scmi_notify_instance *ni,
...
@@ -1084,6 +1402,12 @@ int scmi_notification_init(struct scmi_handle *handle)
 	ni->gid = gid;
 	ni->handle = handle;
...
@@ -1129,5 +1453,8 @@ void scmi_notification_exit(struct scmi_handle *handle)
...
index f0561fb30970..e47ca2bf1945 100644
...
@@ -64,5 +71,7 @@ int scmi_register_protocol_events(const struct scmi_handle *handle,
