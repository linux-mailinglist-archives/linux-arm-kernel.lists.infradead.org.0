...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 85E6C178986
	for <lists+linux-arm-kernel@lfdr.de>; Wed,  4 Mar 2020 05:29:21 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	References:List-Owner; bh=ZAe/LKKGrErYLagNNKcxquCLxxpJggvcLXGCB/zOqY4=; b=ABM
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1j9Lef-0005Gf-3z; Wed, 04 Mar 2020 04:29:09 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
 id 1j9LeU-0005Fx-69
 for linux-arm-kernel@lists.infradead.org; Wed, 04 Mar 2020 04:29:00 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id C116C31B;
 Tue,  3 Mar 2020 20:28:55 -0800 (PST)
Received: from p8cg001049571a15.arm.com (unknown [10.163.1.88])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPA id E26913F534;
 Tue,  3 Mar 2020 20:28:48 -0800 (PST)
From: Anshuman Khandual <anshuman.khandual@arm.com>
To: linux-mm@kvack.org, linux-kernel@vger.kernel.org,
 linux-arm-kernel@lists.infradead.org, akpm@linux-foundation.org,
 catalin.marinas@arm.com, will@kernel.org, rppt@linux.ibm.com
Subject: [PATCH V14 0/2] arm64/mm: Enable memory hot remove
Date: Wed,  4 Mar 2020 09:58:41 +0530
Message-Id: <1583296123-18546-1-git-send-email-anshuman.khandual@arm.com>
X-Mailer: git-send-email 2.7.4
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200303_202858_318977_95ACB3FB 
...
is based on Linux 5.6-rc3 (applies on 5.6-rc4 as well) and particularly
deals with a problem caused when boot memory is attempted to be removed.
...
Changes in V13: (https://lkml.org/lkml/2020/2/12/1416)
