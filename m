...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 968F110C8B0
	for <lists+linux-arm-kernel@lfdr.de>; Thu, 28 Nov 2019 13:29:43 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=GSWEU7KpIRZM5JDntvRCeN75FifePMcSMRU8btgFyT8=; b=Ey4cdbgk8T8N9j1czb3IWF6pb
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iaIvV-0002tS-WC; Thu, 28 Nov 2019 12:29:42 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
 id 1iaIvK-0002t2-SO
 for linux-arm-kernel@lists.infradead.org; Thu, 28 Nov 2019 12:29:32 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id D644B30E;
 Thu, 28 Nov 2019 04:29:26 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 859D83F6C4;
 Thu, 28 Nov 2019 04:29:25 -0800 (PST)
...
Message-ID: <40d07c7d-5d43-534d-759e-1fe7766f8d04@arm.com>
Date: Thu, 28 Nov 2019 12:29:24 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.9.0
MIME-Version: 1.0
In-Reply-To: <23a4ac1c-40c2-94ba-63ff-8c74c26fdbf2@free.fr>
Content-Type: multipart/mixed; boundary="------------13297809C8E74F8DCF8EA543"
Content-Language: en-US
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20191128_042931_010745_293BBD5C 
...
>>
>>> Running 'make C=3D2' on v5.4 (arm64 defconfig) outputs:
>>>
...
>>>
>>
>> I downloaded the latest git of sparse and seems that the only warning =
I am
>> getting is:
>>
>> linux/lib/vdso/gettimeofday.c:224:5: warning: symbol '__cvdso_clock_ge=
tres' was
...
No problem. I use the latest version built from git in my dev environment=
 and
export it in the PATH. This does not break apt. An alternative could be t=
o
