...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 087CE167E02
	for <lists+linux-arm-kernel@lfdr.de>; Fri, 21 Feb 2020 14:08:36 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	Resent-From:Resent-Sender:Resent-To:Resent-Cc:Resent-Message-ID:List-Owner;
	 bh=MgHCrKXZfhojTcga6ncUz3+p5v8JSC1eeMaTbar7ZcI=; b=SCPC/Wl2f5TkJHJ34XkVHOS8o
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1j582f-0008Fi-8w; Fri, 21 Feb 2020 13:08:29 +0000
Received: from foss.arm.com ([217.140.110.172])
 by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
 id 1j582U-0008FK-Q4
 for linux-arm-kernel@lists.infradead.org; Fri, 21 Feb 2020 13:08:20 +0000
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
 by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id CA32730E;
 Fri, 21 Feb 2020 05:08:17 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
 by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 2399E3F703;
...
X-Pep-Version: 2.0
Message-ID: <78402293-113d-85ec-822e-ae87bb8808ef@arm.com>
Date: Fri, 21 Feb 2020 13:08:13 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.4.1
MIME-Version: 1.0
In-Reply-To: <c86bbd4e-5992-c1c9-ed31-9ea04d392588@samsung.com>
Content-Type: multipart/mixed; boundary="------------9FB195211F4D72E70D58151E"
Content-Language: en-US
X-CRM114-Version: 20100106-BlameMichelson ( TRE 0.8.0 (BSD) ) MR-646709E3 
X-CRM114-CacheID: sfid-20200221_050818_939801_A7B2C753 
...
>>
>> Convert ARM/ARM64 to the generic VDSO clock mode storage. This needs t=
o
...
> ...
>=20
> drivers/clocksource/arm_arch_timer.c:73:44: error:=20
> =E2=80=98VDSO_CLOCKMODE_ARCHTIMER=E2=80=99 undeclared here (not in a fu=
nction)
>  =C2=A0static enum vdso_clock_mode vdso_default =3D VDSO_CLOCKMODE_ARCH=
TIMER;
>  =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=
=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 ^
> scripts/Makefile.build:267: recipe for target=20
> 'drivers/clocksource/arm_arch_timer.o' failed
> make[2]: *** [drivers/clocksource/arm_arch_timer.o] Error 1
> make[2]: *** Waiting for unfinished jobs....
> scripts/Makefile.build:505: recipe for target 'drivers/clocksource' fai=
led
...
[1]  https://lore.kernel.org/lkml/20200221130355.21373-1-vincenzo.frascin=
o@arm.com/
--=20
Regards,
Vincenzo
