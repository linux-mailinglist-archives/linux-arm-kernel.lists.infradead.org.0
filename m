...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 3D50E2BA85
	for <lists+linux-arm-kernel@lfdr.de>; Mon, 27 May 2019 21:07:29 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	References:List-Owner; bh=KCnvMDQgl1DnJNmt0hom15v//lwzWr5ZYb7mNxCIXqo=; b=TH/
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.90_1 #2 (Red Hat Linux))
	id 1hVKxy-0005LR-AV; Mon, 27 May 2019 19:07:26 +0000
Received: from mga14.intel.com ([192.55.52.115])
 by bombadil.infradead.org with esmtps (Exim 4.90_1 #2 (Red Hat Linux))
 id 1hVKxp-0005LD-7H
 for linux-arm-kernel@lists.infradead.org; Mon, 27 May 2019 19:07:19 +0000
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
 by fmsmga103.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384;
 27 May 2019 12:07:16 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.60,520,1549958400"; 
 d="gz'50?scan'50,208,50";a="178993812"
Received: from lkp-server01.sh.intel.com (HELO lkp-server01) ([10.239.97.150])
 by fmsmga002.fm.intel.com with ESMTP; 27 May 2019 12:07:14 -0700
Received: from kbuild by lkp-server01 with local (Exim 4.89)
 (envelope-from <lkp@intel.com>)
 id 1hVKxm-000Eab-BI; Tue, 28 May 2019 03:07:14 +0800
Date: Tue, 28 May 2019 03:07:05 +0800
From: kbuild test robot <lkp@intel.com>
To: Vivien Didelot <vivien.didelot@savoirfairelinux.com>
Subject: [arm:clearfog 2/11]
 drivers/net/dsa/mv88e6xxx/mv88e6xxx_debugfs.c:776:27: error:
 'GLOBAL_VTU_VID_MASK' undeclared; did you mean 'LAST__PID_MASK'?
Message-ID: <201905280303.4JZdfuB8%lkp@intel.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="gBBFr7Ir9EOA20Yy"
Content-Disposition: inline
X-Patchwork-Hint: ignore
User-Agent: Mutt/1.5.23 (2014-03-12)
X-Spam-Note: CRM114 run bypassed due to message size (103893 bytes)
X-Spam-Score: -5.0 (-----)
...
>> drivers/net/dsa/mv88e6xxx/mv88e6xxx_debugfs.c:776:27: error: 'GLOBAL_VTU_VID_MASK' undeclared (first use in this function); did you mean 'LAST__PID_MASK'?
   ...
   drivers/net/dsa/mv88e6xxx/mv88e6xxx_debugfs.c:930:37: warning: passing argument 3 of 'mv88e6xxx_get_strings' makes integer from pointer without a cast [-Wint-conversion]
     mv88e6xxx_get_strings(chip->ds, 0, strs);
                                        ^~~~
   drivers/net/dsa/mv88e6xxx/chip.c:983:13: note: expected 'u32 {aka unsigned int}' but argument is of type 'char *'
    static void mv88e6xxx_get_strings(struct dsa_switch *ds, int port,
                ^~~~~~~~~~~~~~~~~~~~~
   In file included from drivers/net/dsa/mv88e6xxx/chip.c:2552:0:
   drivers/net/dsa/mv88e6xxx/mv88e6xxx_debugfs.c:930:2: error: too few arguments to function 'mv88e6xxx_get_strings'
     mv88e6xxx_get_strings(chip->ds, 0, strs);
     ^~~~~~~~~~~~~~~~~~~~~
   drivers/net/dsa/mv88e6xxx/chip.c:983:13: note: declared here
    static void mv88e6xxx_get_strings(struct dsa_switch *ds, int port,
                ^~~~~~~~~~~~~~~~~~~~~
   In file included from drivers/net/dsa/mv88e6xxx/chip.c:2552:0:
   drivers/net/dsa/mv88e6xxx/mv88e6xxx_debugfs.c: In function 'mv88e6xxx_device_map_show':
   drivers/net/dsa/mv88e6xxx/mv88e6xxx_debugfs.c:987:14: error: 'MV88E6XXX_G2_DEVICE_MAPPING_PORT_MASK' undeclared (first use in this function); did you mean 'MV88E6352_G2_DEVICE_MAPPING_PORT_MASK'?
          data & MV88E6XXX_G2_DEVICE_MAPPING_PORT_MASK);
                 ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
                 MV88E6352_G2_DEVICE_MAPPING_PORT_MASK
   cc1: some warnings being treated as errors

vim +776 drivers/net/dsa/mv88e6xxx/mv88e6xxx_debugfs.c

   772	
   773	static int mv88e6xxx_vtu_show(struct seq_file *s, void *p)
   774	{
   775		struct mv88e6xxx_chip *chip = s->private;
 > 776		int port, ret = 0, vid = GLOBAL_VTU_VID_MASK; /* first or lowest VID */
   777	
   778		seq_puts(s, " VID  FID  SID");
   779		for (port = 0; port < mv88e6xxx_num_ports(chip); ++port)
   780			seq_printf(s, " %2d", port);
   781		seq_puts(s, "\n");
   782	
   783		mutex_lock(&chip->reg_lock);
   784	
   785		ret = _mv88e6xxx_vtu_vid_write(chip, vid);
   786		if (ret < 0)
   787			goto unlock;
   788	
   789		do {
   790			struct mv88e6xxx_vtu_entry next = { 0 };
   791	
   792			ret = _mv88e6xxx_vtu_getnext(chip, &next);
   793			if (ret < 0)
   794				goto unlock;
   795	
   796			if (!next.valid)
   797				break;
   798	
   799			seq_printf(s, "%4d %4d   %2d", next.vid, next.fid, next.sid);
   800			for (port = 0; port < mv88e6xxx_num_ports(chip); ++port) {
   801				switch (next.data[port]) {
   802				case GLOBAL_VTU_DATA_MEMBER_TAG_UNMODIFIED:
   803					seq_puts(s, "  =");
   804					break;
   805				case GLOBAL_VTU_DATA_MEMBER_TAG_UNTAGGED:
   806					seq_puts(s, "  u");
   807					break;
   808				case GLOBAL_VTU_DATA_MEMBER_TAG_TAGGED:
   809					seq_puts(s, "  t");
   810					break;
   811				case GLOBAL_VTU_DATA_MEMBER_TAG_NON_MEMBER:
   812					seq_puts(s, "  x");
   813					break;
   814				default:
   815					seq_puts(s, " ??");
   ...
   820	
   821			vid = next.vid;
   822		} while (vid < GLOBAL_VTU_VID_MASK);
   823	
   824	unlock:
...
H4sICLUg7FwAAy5jb25maWcAlDzbctw2su/5iinnJaktO5LsyD7nlB5AEpyBhyQYABzN+IWl
