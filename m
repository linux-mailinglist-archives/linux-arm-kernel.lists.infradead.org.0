...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 97F84ED7E1
	for <lists+linux-arm-kernel@lfdr.de>; Mon,  4 Nov 2019 03:53:17 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	List-Owner; bh=PkieiOzdyS/+v88oGrnDSHdzJ0ItDMFwFnFl+yOSKa8=; b=n9iie8D+LjA/ZM
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1iRSUV-0005NH-Lp; Mon, 04 Nov 2019 02:53:15 +0000
Received: from mail-eopbgr80089.outbound.protection.outlook.com ([40.107.8.89]
 helo=EUR04-VI1-obe.outbound.protection.outlook.com)
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1iRSU4-00059K-V2
 for linux-arm-kernel@lists.infradead.org; Mon, 04 Nov 2019 02:52:53 +0000
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 04 Nov 2019 02:52:44.2690 (UTC)
...
X-CRM114-CacheID: sfid-20191103_185249_409696_3E55DCCC 
...
@@ -294,31 +295,39 @@ static const char * const imx8mn_clko2_sels[] = {"osc_24m", "sys_pll2_200m", "sy
...
+	clks[IMX8MN_CLK_EXT4] = imx_obtain_fixed_clk_hw(np, "clk_ext4");
 	...
 	base = of_iomap(np, 0);
@@ -327,87 +336,87 @@ static int imx8mn_clocks_probe(struct platform_device *pdev)
...
@@ -417,161 +426,165 @@ static int imx8mn_clocks_probe(struct platform_device *pdev)
 	}
